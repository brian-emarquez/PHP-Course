...
<body>
		...
		<section id="posts">
			...
			<ul>
				<li>
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vitae suscipit ex, nec consequat nisl. Aliquam eleifend eros sapien, nec venenatis tortor semper in. <a href="leer.html">Leer completo</a></p>
					<small>Publicado el 22/01 en categoria - 5 comentarios</small>
				</li>
				<li>
					<h3>Titulo post</h3>
					<img src="https://placebear.com/402/132" alt="Titulo post"  />
					<p>Nulla pretium purus in nibh elementum tristique. Ut non neque in odio sagittis ullamcorper. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed egestas condimentum neque quis ultricies. Fusce ac pulvinar orci. Nam sollicitudin malesuada blandit. <a href="leer.html">Leer completo</a></p>
					<small>Publicado el 22/01 en categoria - 5 comentarios</small>
				</li>
				<li>
					<h3>Titulo post</h3>
					<img src="https://placebear.com/403/133" alt="Titulo post"  />
					<p>Morbi a urna aliquet, rhoncus justo quis, cursus dui. Nam et leo suscipit, tempor arcu eu, convallis lectus. Quisque vehicula dictum enim, vitae fringilla tellus ullamcorper et. In sit amet erat tellus. <a href="leer.html">Leer completo</a></p>
					<small>Publicado el 22/01 en categoria - 5 comentarios</small>
				</li>
				<li>
					<h3>Titulo post</h3>
					<img src="https://placebear.com/404/134" alt="Titulo post"  />
					<p>Proin ultrices rhoncus justo quis consequat. Pellentesque in ultricies ex. Nunc sed sapien placerat, faucibus ante non, pulvinar est. Suspendisse potenti. Sed porttitor molestie diam, quis aliquet ligula aliquet in. <a href="leer.html">Leer completo</a></p>
					<small>Publicado el 22/01 en categoria - 5 comentarios</small>
				</li>
				<li>
					<h3>Titulo post</h3>
					<img src="https://placebear.com/405/135" alt="Titulo post"  />
					<p>Nullam justo turpis, iaculis ut gravida vitae, venenatis eget mauris. Nam tristique ligula ipsum, eget rhoncus orci tristique laoreet. Nulla eros neque, eleifend mollis augue vitae, rutrum condimentum nisl. <a href="leer.html">Leer completo</a></p>
					<small>Publicado el 22/01 en categoria - 5 comentarios</small>
				</li>
				<li>
					<h3>Titulo post</h3>
					<img src="https://placebear.com/406/136" alt="Titulo post"  />
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vitae suscipit ex, nec consequat nisl. Aliquam eleifend eros sapien, nec venenatis tortor semper in. Sed sed ornare odio, sit amet ullamcorper lectus. <a href="leer.html">Leer completo</a></p>
					<small>Publicado el 22/01 en categoria - 5 comentarios</small>
				</li>
			</ul>
		...
		<section id="comments">
			...
			<ul>
				...
				<li>
					...
					<p>Nulla pretium purus in nibh elementum tristique. Ut non neque in odio sagittis ullamcorper. Interdum et malesuada fames ac ante ipsum primis in faucibus. <a href="leer.html">Leer completo</a></p>
				</li>
				<li>
					<h3>Usuario</h3>
					<img src="uploads/avatar-thumbs/000_femenino.jpg" alt="Usuario" />
					<p>Morbi a urna aliquet, rhoncus justo quis, cursus dui. Nam et leo suscipit, tempor arcu eu, convallis lectus. Quisque vehicula dictum enim, vitae fringilla tellus ullamcorper et.  <a href="leer.html">Leer completo</a></p>
				</li>
			</ul>
		</section>
		*/
	...
	<aside>
		...
		<?php 
		// CONDICIONAL
		if( $logueado == true ){ //Si no está logueado, mostramos el formulario de login.
		?>
